...
use crate::game::{scene::{bullet_board::BulletBoard, menu::MenuState}, state::state::AppState};
...
impl Plugin for MenuTransitionPlugin {
    fn build(&self, app: &mut App) {
        app
            .init_resource::<MenuTransition>()
            .add_systems(PostUpdate,update_menu_state.run_if(in_state(AppState::Level)));
    }
}
